package dev.mbo.keycloak.admin.api.client;
...
import dev.mbo.keycloak.admin.api.client.auth.Authentication;
import dev.mbo.keycloak.admin.api.client.auth.HttpBasicAuth;
import dev.mbo.keycloak.admin.api.client.auth.HttpBearerAuth;
import dev.mbo.keycloak.admin.api.client.auth.ApiKeyAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    protected void init() {
        ...
        authentications.put("access_token", new HttpBearerAuth("bearer"));
